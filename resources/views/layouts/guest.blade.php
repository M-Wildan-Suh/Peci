...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body x-data="{ loading: true }" 
        ...
        <div class=" w-screen h-screen flex items-center justify-center bg-gradient-to-br from-second to-main px-4">
            <div class=" w-full max-w-4xl mx-auto">
                <div
                    class=" w-full md:aspect-[3/2] p-4 grid grid-cols-1 md:grid-cols-2 gap-4 shadow-md shadow-black/20 rounded-md overflow-hidden bg-background">
                    <div class=" rounded-md overflow-hidden relative">
                        <div style="background-image: url('https://i.pinimg.com/originals/5e/4f/30/5e4f309c7e6bb2e63dbfbd5b96eb904b.jpg')" class=" w-full h-full bg-cover"></div>
                        <div class=" absolute w-full h-full top-0 left-0 bg-black/30"></div>
                    </div>
